...
export default function EditPurchaseInvoicePage({ params }: PageProps) {
  ...
  return <EditPurchaseInvoiceContent id={resolvedParams.id} />;
}

function EditPurchaseInvoiceContent({ id }: { id: string }) {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      showToast("✅ Facture d'achat mise à jour avec succès", "success");
  ...
  return (
    <Toast.Provider>
      <div className="p-6">
        <PageBreadcrumb pageTitle="Modifier Facture d'Achat" />
