...
const createRawMaterial = async (data: any) => {
  ...
  if (!response.ok) {
    ...
    throw new Error(error.message || "Échec de la création de la matière première");
  }
...
export default function AddRawMaterialPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      showToast("✅ Matière première créée avec succès", "success");
  ...
  return (
    <Toast.Provider>
      <div className="p-6">
        <PageBreadcrumb pageTitle="Ajouter une matière première" />
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
            <h3 className="text-xl font-semibold text-black dark:text-white">
              Informations de la matière première
            </h3>
          </div>
              ...
              <div className="mt-6 flex gap-4">
                ...
                >
                  {isSubmitting ? (
                    ...
                    "Enregistrer la matière première"
                  )}
                </button>
              </div>
            </div>
